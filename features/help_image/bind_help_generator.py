...
BIND_COMMAND_SECTIONS = [
    ...
    },
    {
        ...
        "title": "解绑账号",
        "items": [
            ("/解绑", "从群昵称提取游戏ID，解绑自己的账号"),
            ("/解绑 <游戏ID>", "解绑自己的账号（游戏ID必须属于自己）"),
            ("/解绑 ID <游戏ID>", "【管理员】按游戏ID解绑任意账号"),
            ("/解绑 QQ <QQ号>", "【管理员】按QQ号解绑（可能涉及多个游戏ID）"),
            ("/解绑 <游戏ID> -s <服务器名>", "指定服务器解绑（仅本地模式需要）"),
        ]
    },
    {
        "icon": "",
        ...
        "items": [
            ("/查绑定", "从群昵称自动提取游戏ID查询"),
            ("/查绑定 <游戏ID>", "查询游戏ID绑定的QQ号"),
            ("/查绑定 ID <游戏ID>", "同上，显式指定ID"),
            ("/查绑定 QQ <QQ号>", "查询QQ号绑定的所有游戏ID"),
        ]
    },
    {
        "icon": "",
...
NOTE_TEXT_BIND = "绑定码在游戏内 Title/ActionBar 中显示，有效期5分钟自动刷新"
